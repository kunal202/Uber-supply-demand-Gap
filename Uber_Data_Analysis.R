...
#DATA CLEANING part will start from here
...
sum(is.na(Uber.request.data$Drop.timestamp)) #(we will not consider this beacause this field is of no interest to us
                                            #we have write this to show that there could be other result of it other than 0)          
...
#DATA CLEANING is finished here
